package edu.lu.uni.deeplearning.VBNNPNNP;
...
public class CNNon_feature_raw_tokens_without_operators {
	
	/**
	 * Number of label classes:
	 * 197
	 */
	private static Logger log = LoggerFactory.getLogger(CNNon_feature_raw_tokens_without_operators.class);
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException {
		String fileName = "apache$commons-math$feature-raw-tokens-without-operators(SIMPLIFIED_NLP)(3)MaxSize=69.csv";
