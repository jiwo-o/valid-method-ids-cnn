...
public class CNNon_feature_raw_tokens_with_operators {
	
	/**
	 * Number of label classes:
	 * 196
	 */
	private static Logger log = LoggerFactory.getLogger(CNNon_feature_raw_tokens_with_operators.class);
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException {
		String fileName = "apache$commons-math$feature-raw-tokens-with-operators(SIMPLIFIED_NLP)(2)MaxSize=81.csv";
